...
document.getElementById("load-code-with-policy-name-only").onclick = () => {
  performDynamicLoad("../dynamic-content/trusted-types-policy-regular/main.js");
};

document.getElementById("load-code-with-continue-on-policy-creation-failure").onclick = () => {
  performDynamicLoad("../dynamic-content/trusted-types-policy-continue-on-error/main.js");
};
